...
using NuocMam.Model.Model;

namespace NuocMamReal.Controllers
{
    public class AspNetUsersController : Controller
    {
        private readonly IAspNetUser _user;
        private NuocMamRealEntities db = new NuocMamRealEntities();
        public AspNetUsersController(IAspNetUser aspNetUser)
        {
            _user = aspNetUser;
        }
        // GET: AspNetUsers
        public async Task<ActionResult> Index()
        {
            ...
            var userViewModel = user.Select(u => new AspNetUserModel()
            {
                Email = u.Email,
